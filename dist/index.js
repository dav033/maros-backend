...
app.post("/contact-us", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, name, email, phone, message, subject, apiKey, response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _req$body = req.body, name = _req$body.name, email = _req$body.email, phone = _req$body.phone, message = _req$body.message, subject = _req$body.subject;
          console.log(req.body);
          if (!(!name || !email)) {
            _context.next = 5;
            break;
          }
          return _context.abrupt("return", res.status(400).send("Missing required fields"));
        case 5:
          ...
          return _context.abrupt("return", res.status(500).send("API key not defined"));
        case 8:
